...
require (
	...
	github.com/henrylamb/object-generation-golang v0.0.0-20250206082907-9a360bddb9b8
...
exclude github.com/henrylamb/object-generation-golang v0.0.0-20250707160731-5b550e9d30db
